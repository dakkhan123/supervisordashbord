                  ...
                  <div className="p-6 flex flex-col gap-5">
                    <div className="flex items-center justify-between py-3 border-b border-outline-variant/30">
                      <div className="flex-1 pr-4">
                        <p className="text-xs font-bold text-on-surface">Critical Low Stock Emails</p>
                        <p className="text-[11px] text-on-surface-variant leading-relaxed">
                          Receive an instant email digest immediately when any item stock level falls into the Critical safety zone.
                        </p>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input
                          type="checkbox"
                          id="criticalEmail"
                          checked={notificationSettings.criticalEmail}
                    ...
                    <div className="flex items-center justify-between py-3 border-b border-outline-variant/30">
                      <div className="flex-1 pr-4">
                        <p className="text-xs font-bold text-on-surface">Dispatch SMS Confirmations</p>
                        <p className="text-[11px] text-on-surface-variant leading-relaxed">
                          Send automated SMS alerts to operators and transporters upon dispatching stock shipments.
                        </p>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input
                          type="checkbox"
                          id="dispatchSMS"
                          checked={notificationSettings.dispatchSMS}
                          onChange={handleNotificationChange}
                          className="sr-only peer"
                        />
                        <div className="w-10 h-5 bg-outline-variant rounded-full peer peer-focus:ring-2 peer-focus:ring-primary/20 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-primary"></div>
                    ...
                    <div className="flex items-center justify-between py-3 border-b border-outline-variant/30">
                      <div className="flex-1 pr-4">
                        <p className="text-xs font-bold text-on-surface">Weekly Executive Summary</p>
                        <p className="text-[11px] text-on-surface-variant leading-relaxed">
                          Email a consolidated PDF report of stock inflows, outflows, GST compliance audits, and reorders every Monday morning.
                        </p>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input
                    ...
                    <div className="flex items-center justify-between py-3">
                      <div className="flex-1 pr-4">
                        <p className="text-xs font-bold text-on-surface">WhatsApp Business Alerting</p>
                        <p className="text-[11px] text-on-surface-variant leading-relaxed">
                          Deliver urgent emergency order notifications and approval requests straight to the registered WhatsApp phone number.
                        </p>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input
                  ...
                  <div className="flex items-start justify-between flex-wrap gap-3">
                    <div>
                      ...
                      <p className="text-[11px] text-on-surface-variant mt-0.5">
                        Audit and manage all database-logged system notification events.
                      </p>
                    </div>
                          ...
                          {paginatedHistory.length === 0 && (
                            <tr>
                              <td colSpan="6" className="p-10 text-center text-outline">
                                No matching notification logs found in database.
                              </td>
                            </tr>
                          )}
                        </tbody>
