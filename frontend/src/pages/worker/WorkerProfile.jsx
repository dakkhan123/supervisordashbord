    ...
    <div className="flex flex-col gap-6 max-w-4xl mx-auto text-on-surface font-sans">
      ...
      <div className="bg-surface-lowest border border-outline-variant rounded-md p-6 shadow-sm flex flex-col gap-6">
        <div className="flex items-center gap-4 border-b border-outline-variant/40 pb-6">
          <div className="w-16 h-16 rounded-full bg-[#213145] text-primary-fixed font-black text-2xl flex items-center justify-center uppercase shadow-sm">
          ...
          <div>
            ...
            <span className="inline-block mt-2 px-3 py-0.5 bg-primary/10 text-primary border border-primary/20 font-extrabold text-[10px] rounded-full uppercase tracking-wider">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
          <div className="p-4 bg-surface-low border border-outline-variant rounded-sm">
        ...
        <div className="p-4 bg-amber-500/10 border border-amber-500/30 rounded-sm text-xs text-amber-700 font-medium">
